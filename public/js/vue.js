...
if (typeof store !== 'undefined' && !_.isUndefined(store) && !_.isEmpty(store)) {
  vueOptions.store = new vuex__WEBPACK_IMPORTED_MODULE_3__["default"].Store(store);
} // --------------------------------------------------------------------------
// --------------------------------------------------------------------------
...
module.exports = __webpack_require__(/*! C:\Users\Wiku\Documents\BitBucket\laravel6-starter-kit\resources\js\vue.js */"./resources/js/vue.js");
