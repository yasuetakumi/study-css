...
class LogSuperAdminActivityController extends Controller
{
    ...
    public function index(){
        $data['page_title'] = __('label.log_activity') . __('label.superAdmin'). __('label.list');
        return view('backend.logactivity.index_superadmin', $data);
    }
}
