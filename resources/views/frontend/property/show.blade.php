...
@section('content')
    ...
    @component('frontend._components.text_label', ['label' => __('label.cost_of_rent'), 'value' => $item->rent_amount ? yenPerTsubo($item->rent_amount, $item->surface_area, true) : '' ])@endcomponent
