    ...
    <div class="col-xs-12 col-sm-12 col-md-9 col-lg-10 col-content">
        <div class="field-group clearfix">
            ...
            <div class="position-relative mt-1">
                ...
                <input id="input-{{$name}}" type="text" class="" :value="{{$model}}" name="{{$name}}" {{ !empty($required) && $required != 'false' ? 'required' : '' }} data-parsley-required-message="@lang('validation.required', ['attribute' => $label])" data-parsley-errors-container = "#errorBlock-{{$name}}">
            </div>
