...
@section('content')
    ...
    @component('backend._components.input_text', ['name' => 'surface_area', 'label' => __('label.surface_area_tsubo'), 'required' => null, 'value' => $item->tsubo, 'isReadOnly' => true ]) @endcomponent
    ...
    @component('backend._components.input_number', ['name' => 'cost_of_rent', 'label' => __('label.cost_of_rent'), 'required' => null, 'value' => $item->man_per_tsubo, 'isReadOnly' => true]) @endcomponent
