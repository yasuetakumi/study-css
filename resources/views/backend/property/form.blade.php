...
@section('content')
    @component('backend._components.form_container', ["action" => $form_action, 'id' => 'property-form',  "page_type" => $page_type, "files" => true])
        ...
        @component('backend._components.input_number', ['name' => 'renewal_fee', 'label' => __('label.renewal_fee') . '(万)', 'required' => null, 'value' => $item->renewal_fee ?? '', 'isReadOnly' => $disableForm ]) @endcomponent
