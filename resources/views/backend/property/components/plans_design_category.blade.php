                            ...
                            <div class="row">
                                <div v-for="plan in plans_design_category_1" :key="plan.id" class="col-md-3">
                                    ...
                                    <div class="icheck-cyan d-inline" >
                                        <input :checked="items.selected_plan_dc_1 != null && items.selected_plan_dc_1 == plan.id" type="radio" :value="plan.id"
                                        :id="'plan-dc-1-'+ plan.display_name" v-model="items.selected_plan_dc_1" name="plan_id_dc_1"
                                        :data-parsley-required="plans_design_category_1 ? 'true' : 'false' " data-parsley-required-message="@lang('validation.required', ['attribute' => '居酒屋'])" />
                        ...
                        <div class="mb-2" v-if="plans_design_category_2">
                            <div class="row" >
                                <div v-for="plan in plans_design_category_2" :key="plan.id" class="col-md-3">
                                    <img :src="pathToImage + plan.id +'/'+ plan.thumbnail_image" alt="" v-on:error="handleImageNotFound" class="w-100 img-thumbnail d-block mx-auto">
                                    <div class="icheck-cyan d-inline" >
                                        <input :checked="items.selected_plan_dc_2 != null && items.selected_plan_dc_2 == plan.id" type="radio" :value="plan.id"
                                        :id="'plan-dc-2-'+ plan.display_name" v-model="items.selected_plan_dc_2" name="plan_id_dc_2"
                                        :data-parsley-required="plans_design_category_2 ? 'true' : 'false' " data-parsley-required-message="@lang('validation.required', ['attribute' => 'カフェ'])" />
                        ...
                        <div class="mb-2" v-if="plans_design_category_3">
                            <div class="row" >
                                <div v-for="plan in plans_design_category_3" :key="plan.id" class="col-md-3">
                                    <img :src="pathToImage + plan.id +'/'+ plan.thumbnail_image" alt="" v-on:error="handleImageNotFound" class="w-100 img-thumbnail d-block mx-auto">
                                    <div class="icheck-cyan d-inline" >
                                        <input :checked="items.selected_plan_dc_3 != null && items.selected_plan_dc_3 == plan.id" type="radio" :value="plan.id"
                                        :id="'plan-dc-3-'+ plan.display_name" v-model="items.selected_plan_dc_3" name="plan_id_dc_3"
                                        :data-parsley-required="plans_design_category_3 ? 'true' : 'false' " data-parsley-required-message="@lang('validation.required', ['attribute' => 'バー'])"/>
                        ...
                        <div class="mb-2" v-if="plans_design_category_4">
                            <div class="row">
                                <div v-for="plan in plans_design_category_4" :key="plan.id" class="col-md-3">
                                    <img :src="pathToImage + plan.id +'/'+ plan.thumbnail_image" alt="" v-on:error="handleImageNotFound" class="w-100 img-thumbnail d-block mx-auto">
                                    <div class="icheck-cyan d-inline" >
                                        <input :checked="items.selected_plan_dc_4 != null && items.selected_plan_dc_4 == plan.id" type="radio" :value="plan.id"
                                        :id="'plan-dc-4-'+ plan.display_name" v-model="items.selected_plan_dc_4" name="plan_id_dc_4"
                                        :data-parsley-required="plans_design_category_4 ? 'true' : 'false' " data-parsley-required-message="@lang('validation.required', ['attribute' => 'ラーメン'])"/>
