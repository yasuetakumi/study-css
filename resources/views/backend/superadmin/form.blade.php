...
@section('breadcrumbs')
    <ol class="breadcrumb float-sm-right">
        @if($isAdminLogin)
            ...
            <li class="breadcrumb-item"><a href="{{route('admin.superadmin.index')}}">@lang('label.superAdmin') @lang('label.list')</a></li>
        @else
...
@section('top_buttons')
    @if ($page_type == "create")
        <a href="{{route('admin.superadmin.index')}}" class="btn btn-secondary float-sm-right">@lang('label.list')</a>
    @else
        <a href="{{route('admin.superadmin.create')}}" class="btn btn-secondary float-sm-right">@lang('label.createNew')</a>
        <a href="{{route('admin.superadmin.index')}}" class="btn btn-secondary float-sm-right">@lang('label.list')</a>
    @endif
@endsection
