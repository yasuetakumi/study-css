            ...
            <nav class="navbar navbar-expand-lg navbar-light" style="background-color: #446eb8;">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav mr-auto">
                        ...
                        <!-- C-1-2 -->
                        <li class="nav-item border-right">
                            <search-condition-list isbutton="false" label="希望にマッチした物件" islogin="{{auth()->guard('member')->check() ? auth()->guard('member')->user()->id : '' }}"  ref="SearchConditionList"></search-condition-list>
                        </li>
                        <!-- C-1-3 -->
